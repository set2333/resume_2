  ...
  <>
    ...
    <ul>
      ...
      <ListItem>
        Мой
        {' '}
        <a href="https://habr.com/ru/users/set2333/">Хабр</a>
        {' '}
        аккаунт.
      </ListItem>
      <ListItem>
      ...
      <ListItem>
        Аккаунт на
        {' '}
        <a href="https://github.com/set2333/">Гитхабе.</a>
      </ListItem>
      <ListItem>
      ...
      <ListItem>
        А вот
        {' '}
        <a href="https://drive.google.com/open?id=18QpwXxgM2pvLe-SYb5ftMry-rkhhJhLQ">сертификат</a>
        {' '}
    ...
    <ul>
      ...
      <ListItem>
        Аккаунт на
        {' '}
        <a href="https://www.chess.com/member/set2333">Chees.com</a>
      </ListItem>
      <ListItem>
